...
public class TablonDeAnuncios {
	...
	public void publicarAnuncio(Anuncio anuncio,
		...
		/*
		 * if (bdAnunciantes.buscarAnunciante(anuncio.anunciante_)==false) {
			...
			if ((bdAnunciantes.buscarAnunciante(anuncio.anunciante_))) {
				...
				if (bdPagos.anuncianteTieneSaldo(anuncio.anunciante_)) {
					...
					if (buscarAnuncioPorTitulo(anuncio.titulo_) == null
							|| buscarAnuncioPorTitulo(anuncio.titulo_).anunciante_ != anuncio.anunciante_) {
						listaDeAnuncios_.add(anuncio);
	...
	public void borrarAnuncio(String titulo, String anunciante) {
		for (Anuncio anuncio : listaDeAnuncios_) {
			if ((anuncio.titulo_.equals(titulo) && (anuncio.anunciante_
					.equals(anunciante))))
